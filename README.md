...
| What is block 1 and block 2? (more than just strand A and B) | compare the RMSD (root-mean-square deviation) of two specific blocks within your DNA helix to a reference DNA strand. |
